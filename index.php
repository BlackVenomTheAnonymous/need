...
<html class="loading">
  <head>
    ...
    <title>CᴏᴅᴇヤCrafting⎋Nexus</title>
...
<h5>LIMIT :<span class="badge badge-primary float-right">5000</span></h5><hr>
...
if(total > 5000){
  Swal.fire({title: 'Sorry But Limit of Cards are 5000 only :(', icon: 'warning', showConfirmButton: false, toast: true, position: 'top-end', timer: 3000});
  return false;
}
